#Presentation 1 : basic camera opening to cursor movement : (Press space to "upgrade")
...
##############################################################
        ...
        for face in faces:
            ...
            if space_count ==2:
                for n in range(0, landmarks.num_parts):#all landmarks
